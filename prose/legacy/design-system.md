...
--background: oklch(0.145 0 0) /* Main app background - zinc-900 equivalent */
	--card: oklch(0.145 0 0) /* Card backgrounds */ --popover: oklch(0.145 0 0)
	/* Popover backgrounds */ Sidebar: zinc-900 (#18181b) TopMenu: zinc-800 (#27272a) Editor
	Toolbar: zinc-800 (#27272a) Editor Background: zinc-900 (#18181b) Preview Background: white
	(#ffffff);
```
...
--foreground: oklch(0.985 0 0) /* Primary text - zinc-100 equivalent */
	--muted-foreground: oklch(0.708 0 0) /* Secondary text - zinc-400 equivalent */ Primary
	Text: zinc-100 (#f4f4f5) Secondary Text: zinc-300 (#d4d4d8) Tertiary Text: zinc-400 (#a1a1aa);
```
...
```css
--border: oklch(0.269 0 0) --sidebar-border: oklch(0.269 0 0) Border Color: zinc-700 (#3f3f46);
```
...
--destructive: oklch(0.396 0.141 25.723) /* Error/delete actions */
	--destructive-foreground: oklch(0.637 0.237 25.331) Destructive Hover: red-400 (for delete icons)
...
```css
--background: #ffffff --foreground: oklch(0.145 0 0) Primary Blue: #355e93 (for accents) Secondary
	Blue: (variations of primary) Grays: Various shades for backgrounds and text;
```
...
```css
--ring: oklch(0.708 0 0) /* Light theme */ --ring: oklch(0.439 0 0) /* Dark theme */;
```
