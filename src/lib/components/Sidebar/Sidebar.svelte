...
{#snippet sidebarContent()}
	...
	<div class="relative flex items-center">
		...
		<span
			class="pointer-events-none absolute right-0 left-0 text-center italic font-mono text-lg whitespace-nowrap text-foreground transition-opacity duration-300 {isExpanded
				? 'opacity-100'
				: 'opacity-0'}"
		>
			Tonguetoquill
