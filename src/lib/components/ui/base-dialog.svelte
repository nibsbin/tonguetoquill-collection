...
<style>
	/* Apply semantic tokens to prose content in dialogs */
	:global(.dialog-content .prose) {
		color: hsl(var(--color-foreground));
	}

	:global(.dialog-content .prose h1),
	:global(.dialog-content .prose h2),
	:global(.dialog-content .prose h3),
	:global(.dialog-content .prose h4),
	:global(.dialog-content .prose h5),
	:global(.dialog-content .prose h6) {
		color: hsl(var(--color-foreground));
	}

	:global(.dialog-content .prose p),
	:global(.dialog-content .prose li) {
		color: hsl(var(--color-foreground));
	}

	:global(.dialog-content .prose strong) {
		color: hsl(var(--color-foreground));
		font-weight: 600;
	}

	:global(.dialog-content .prose a) {
		color: hsl(var(--color-primary));
	}

	:global(.dialog-content .prose a:hover) {
		color: hsl(var(--color-primary));
		opacity: 0.8;
	}

	/* Scrollbar styling using semantic tokens */
	:global(.dialog-content .overflow-y-auto::-webkit-scrollbar) {
		width: 8px;
	}

	:global(.dialog-content .overflow-y-auto::-webkit-scrollbar-track) {
		background: hsl(var(--color-muted));
		border-radius: 4px;
	}

	:global(.dialog-content .overflow-y-auto::-webkit-scrollbar-thumb) {
		background: hsl(var(--color-muted-foreground) / 0.3);
		border-radius: 4px;
	}

	:global(.dialog-content .overflow-y-auto::-webkit-scrollbar-thumb:hover) {
