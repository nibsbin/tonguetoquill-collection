...
<Dialog {open} {onOpenChange} title="Terms of Use" scoped size="lg">
	{#snippet content()}
		...
		>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">2. Use License</h2>
				<p>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">3. User Account</h2>
				<p>
					To use certain features of the Service, you may be required to create an account. You are
					responsible for:
				</p>
				<ul class="list-disc space-y-2 pl-6">
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">4. User Content</h2>
				<p>
					...
					license to use, reproduce, and store your content solely for the purpose of providing the
					Service to you.
				</p>
			</section>

			<section>
				<h2 class="mb-4 text-2xl font-semibold">5. Prohibited Uses</h2>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">6. Service Availability</h2>
				<p>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">7. Limitation of Liability</h2>
				<p>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">8. Termination</h2>
				<p>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">9. Changes to Terms</h2>
				<p>
			...
			<section>
				<h2 class="mb-4 text-2xl font-semibold">10. Contact Information</h2>
